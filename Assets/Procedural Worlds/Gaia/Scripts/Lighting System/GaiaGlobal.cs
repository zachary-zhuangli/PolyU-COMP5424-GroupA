...
namespace Gaia
{
    ...
    public class GaiaGlobal : MonoBehaviour
    {
        ...
        public static void FinalizeCameraObjectRuntime(Camera cameraObject, bool closePhotoMode)
        {
            ...
            FollowPlayerSystem[] followPlayerSystems = GaiaUtils.FindOOTs<FollowPlayerSystem>();
            ...
            GaiaPlanarReflectionsHDRP reflectionsHDRP = GaiaUtils.FindOOT<GaiaPlanarReflectionsHDRP>();
