    ...
    public class ProceduralWorldsGlobalWeather : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            try
            {
                ...
                {
                    m_thunderComponent = GaiaUtils.FindOOT<ThunderStrike>();
                }
                ...
                {
                    GaiaGlobal.Instance = GaiaUtils.FindOOT<GaiaGlobal>();
                }
...
#region Weather Setup Functions
        ...
        {
            if (GaiaUtils.FindOOT<CompleteTerrainShader>() == null)
            {
                return null;
            }

            CTSWeatherManager cTSWeatherManager = GaiaUtils.FindOOT<CTSWeatherManager>();
...
#region Utils
        ...
        private WindZone GetOrCreateWindZone()
        {
            try
            {
                ...
                WindZone windSettings = GaiaUtils.FindOOT<WindZone>();
        ...
        public PostProcessProfile GetPostProcessingProfile()
        {
            try
            {
                m_volumes = GaiaUtils.FindOOTs<PostProcessVolume>();
...
#region Public Static Functions
        ...
        public static void RemoveGlobalWindShader()
        {
            ...
            PWSkyPostProcessingManager weatherPostFX = GaiaUtils.FindOOT<PWSkyPostProcessingManager>();
        ...
        public static Transform GetPlayer()
        {
            try
            {
                ...
                m_mainCameras = GaiaUtils.FindOOTs<Camera>();
