...
{
    public class WeatherFXSnow: WeatherFXInstance, IHDRPWeatherVFX
    {
        ...
        private void FadeIn()
        {
            ...
            BaseSettings.SetSnowPowerValue(BaseSettings.LerpFromDuration(0f, BaseSettings.m_weatherProfile.WeatherShaderData.m_snowShaderData.m_snowPower));
        ...
        private void FadeOut()
        {
            ...
            BaseSettings.SetSnowPowerValue(BaseSettings.LerpFromDuration(BaseSettings.m_weatherProfile.WeatherShaderData.m_snowShaderData.m_snowPower, 0f));
