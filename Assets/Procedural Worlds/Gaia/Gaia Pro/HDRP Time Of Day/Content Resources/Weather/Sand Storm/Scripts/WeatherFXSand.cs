...
{
    public class WeatherFXSand: WeatherFXInstance, IHDRPWeatherVFX
    {
        ...
        private void Update()
        {
            ...
            foreach (HDRPWeatherVisualEffect visualEffect in VisualEffects)
            {
                ...
                if (visualEffect.m_setPlayerYPosition)
                {
                    BaseSettings.SetPlayerYPosition(visualEffect.m_visualEffect, "HeightPos");
                }
        ...
        private void FadeIn()
        {
            ...
            BaseSettings.SetSandPowerValue(BaseSettings.LerpFromDuration(0f, BaseSettings.m_weatherProfile.WeatherShaderData.m_sandShaderData.m_sandPower));
        ...
        private void FadeOut()
        {
            ...
            BaseSettings.SetSandPowerValue(BaseSettings.LerpFromDuration(BaseSettings.m_weatherProfile.WeatherShaderData.m_sandShaderData.m_sandPower, 0f));
