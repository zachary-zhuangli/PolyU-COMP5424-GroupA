...
namespace ProceduralWorlds.Flora
{
    ...
    public class FloraMainWindow : EditorWindow, IPWEditor
    {
        ...
        private void OnEnable()
        {
            ...
            m_inScene = FloraUtils.FindOOT<FloraTerrainTile>() != null;
            if (m_inScene)
            {
...
#pragma warning restore 162
        ...
        private void AddToScene()
        {
            ...
            if (terrains.Length > 0)
            {
                ...
                FloraGlobalManager floraGlobalManager = FloraUtils.FindOOT<FloraGlobalManager>();
        ...
        {
#if GAIA_2_PRESENT
            MonoBehaviour[] allScripts = FloraUtils.FindOOTs<MonoBehaviour>();
