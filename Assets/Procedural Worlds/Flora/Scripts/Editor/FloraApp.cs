...
{
    [InitializeOnLoad]
    public static class FloraApp
    {
        public const string CONF_NAME = "Flora";
        ...
        /// <param name="customUpdateMethod">(Optional) The method to be called when the GUI needs to be updated. (Repaint will always be called.)</param>
        /// <returns>Editor Utils</returns>
        public static EditorUtils GetEditorUtils(IPWEditor editorObj, bool getByName, string classNameOverride = null, System.Action customUpdateMethod = null) => new EditorUtils(CONF, editorObj, classNameOverride, customUpdateMethod);
    }
}
