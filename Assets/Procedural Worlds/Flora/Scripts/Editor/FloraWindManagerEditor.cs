...
{
    [CustomEditor(typeof(FloraWindManager))]
    public class FloraWindManagerEditor : PWEditor
    {
        public EditorUtils m_editorUtils;
        private FloraWindManager m_manager;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_manager == null)
            {
                m_manager = (FloraWindManager)target;
            }
